...
export default function SkillsSection() {
  ...
  const skills: Skill[] = [
    ...
    { name: "Python", category: ["languages"], icon: "Py", color: "bg-yellow-500" },
    { name: "Java", category: ["languages"], icon: "Ja", color: "bg-red-500" },
    { name: "JavaScript", category: ["languages"], icon: "JS", color: "bg-yellow-400" },
    { name: "TypeScript", category: ["languages"], icon: "TS", color: "bg-sky-600" },
    { name: "HTML", category: ["languages"], icon: "HTML", color: "bg-orange-500" },
    { name: "CSS", category: ["languages"], icon: "CSS", color: "bg-blue-400" },
    { name: "PHP", category: ["languages"], icon: "PHP", color: "bg-indigo-600" },

    // Frameworks
    { name: "React", category: ["frameworks"], icon: <FileCode className="h-5 w-5" />, color: "bg-cyan-500" },
    { name: "Next.js", category: ["frameworks"], icon: "N", color: "bg-gray-800" },
    { name: "Express.js", category: ["frameworks"], icon: "Ex", color: "bg-zinc-700" },

    // Tools
    { name: "Android Studio", category: ["tools"], icon: <Smartphone className="h-5 w-5" />, color: "bg-green-700" },
    { name: "Arduino", category: ["tools"], icon: "Ar", color: "bg-teal-500" },
    { name: "Blynk", category: ["tools"], icon: "Bl", color: "bg-purple-500" },
    { name: "Tailwind CSS", category: ["tools"], icon: "TW", color: "bg-sky-500" },
    { name: "Pug", category: ["tools"], icon: "P", color: "bg-pink-600" },

    // Databases
    { name: "MySQL", category: ["databases"], icon: "SQL", color: "bg-blue-700" },
    { name: "MongoDB", category: ["databases"], icon: "Mo", color: "bg-green-600" },
    { name: "PostgreSQL", category: ["databases"], icon: "PG", color: "bg-amber-600" },
  ]
            ...
            >
              <Card className="card-hover h-full">
                <CardContent className="p-4 flex flex-col items-center justify-center text-center h-full">
                  <div className={`${skill.color} text-white w-12 h-12 rounded-full flex items-center justify-center font-bold mb-3`}>
                    {skill.icon}
                  </div>
